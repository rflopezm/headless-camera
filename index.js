...
var AuthProvider_1 = require("./src/auth/AuthProvider");
var logger_1 = require("./src/logger");
var ServerMessageProvider_1 = require("./src/ServerMessageProvider");
if (process.env.NODE_ENV !== "production") {
    dotenv_1.config();
}
var username = process.env["IOT_USERNAME"] || "";
var password = process.env["IOT_PASSWORD"] || "";
